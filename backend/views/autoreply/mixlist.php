...
<div class="page-header am-fl am-cf">
    <h4>微信自动回复 <small>&nbsp;/&nbsp;图文回复</small></h4>
</div>
<div id="toolbar" class="btn-group">
    <form class="form-inline">
        <button type="button" class="btn btn-default"  onclick="window.location.href='<?php echo Url::to(['autoreply/mixreply']);?>';">
...
<script type="text/javascript">
    var type='id',stext,order='desc',ids='',imgcon=1,more,eurl="<?php echo Url::to(['autoreply/mixedit']);?>",
        listurl='<?php echo Url::to(['autoreply/mixlist']); ?>',
        durl="<?php echo Url::to(['autoreply/simpledelete','type'=>2]); ?>",
        upturl='<?php echo Url::to(['autoreply/mixedit']);?>',height = $(window).height()-90;
</script>
