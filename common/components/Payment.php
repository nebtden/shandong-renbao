...
require_once "./../../vendor/pay/weixin/lib/WxPay.Api.php";
require_once "./../../vendor/pay/weixin/example/WxPay.JsApiPay.php";
require_once "./../../vendor/pay/weixin/example/log.php";
require_once './../../vendor/pay/weixin/lib/WxPay.Notify.php';

class Payment{
	
	public static function jsApi($info){
		//初始化日志
		$logHandler= new \CLogFileHandler("/home/www/yunche/log/".date('Y-m-d').'.log');
