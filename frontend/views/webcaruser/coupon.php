...
<div class="m-tab" data-ydui-tab>
    ...
    <ul class="tab-nav-inner" style="background: #F2F2F4">
        ...
        <li><a href="javascript:;" data-inner-nav="10">臭氧杀菌</a></li>
                ...
                <div class="tab-panel-inner-item active" data-inner-nav="0" >
                    ...
                    <ul class="card-list-ul">
                        <?php foreach ($list as $val): ?>
                            ...
                            <?php  elseif( $val['coupon_type']==10): ?>
                                service-disinfect

                            <?php endif; ?>
                            <?php  if($val['status']==1): ?>
                            <?php  elseif($val['status']==2 && $val['show_button'] != 'show'):?>
                                invalid
                            ...
                            ">
                                <div class="title ">
                                    ...
                                    <?php  elseif($val['coupon_type']==2): ?>
                                        <span>包年</span>
                                    <?php  elseif($val['coupon_type']==4 || $val['coupon_type']==10): ?>
                                ...
                                <div class="content">
                                    <div class="up">
                                        ...
                                        <div class="right">
                                            <?php if(($val['coupon_type']==4 || $val['coupon_type']==10)  && $val['w_status']==2 && $val['is_mensal']==1):?>
