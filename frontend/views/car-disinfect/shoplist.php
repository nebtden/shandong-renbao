...
<script type="text/javascript">
    ...
    function getshop(lng,lat){
        ...
        var company = '<?= $company;?>';
        YDUI.dialog.loading.open('臭氧杀菌门店加载中');
        $.ajax({
            url: '<?php echo Url::to(['car-disinfect/getshoplist']) ?>',
    ...
    function getareashop(pid,cid,aid){
        ...
        YDUI.dialog.loading.open('臭氧杀菌门店加载中');
        $.ajax({
            url: '<?php echo Url::to(['car-disinfect/getareashoplist']) ?>',
    ...
    function getShopList(data){
        ...
        $.each(data, function(key, val){
            ...
            if(val['shopAvator']){
                ...
                html += '<div class="left commom-img"><img src="/frontend/web/cloudcarv2/images/disinfect.png"></div>';
            }
            html += '<div class="middle"><span>'+ val['shopName'] +'</span> <i> '+ val['shopAddress'] +' </i> </div>';
            html += '<div class="right"><a class="disinfect-a" href="<?php echo Url::to(['car-disinfect/shopdetail', 'couponId' => $couponId,'company'=>$company ]) ?>&shopId='+ val['shopId'] +'" >杀菌</a>' +
