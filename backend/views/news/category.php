...
<script type="text/javascript">
    ...
    var type='id',stext,order='desc',ids='',imgcon= 1,more,eurl="<?php echo Url::to(['news/category_edit']);?>",
        listurl='<?php echo Url::to(['news/category']); ?>',
        durl="<?php echo Url::to(['news/category_del']); ?>";
    ...
    $(function(){
        ...
        $('.btn-default').eq(0).click(function(){
           window.location.href='<?php echo Url::to(['news/category_edit']); ?>';
        });
