...
<div class="place-order-fixed">
    <ul class="place-order-ul">
        ...
        <li class="rescue">
            <span><i></i></span>
            <input class="drive-end" type="text" name="fault_address" placeholder="请输入事故发生地" readonly>
            <input type="hidden" name="lng">
            <input type="hidden" name="lat">
        </li>
        <li class="cardVolume">
            <a href="javascript:;">
                <div class="div-left"><img src="/frontend/web/webcloudcar/images/myCardVolume.png"><i>服务券</i></div>
                <div class="div-right"><span>请选择</span><i class="iconfont icon-car-jiantou"></i></div>
            </a>
...
<div class="jiedaned-fixed">
    <div class="up">
        <img src="<?= $user['headimgurl'] ?>" onerror="this.src='/frontend/web/cloudcar/images/headerpic.png'">
        <div class="up-middle">
...
<script>
    ...
    YDUI.dialog.alert('此项服务需要先完善您的车辆信息', function () {
        window.location.href = "<?php echo Url::to(['webcaruser/carlist']);?>"
    });
    <?php else:?>
    var cMap = new myMap();
