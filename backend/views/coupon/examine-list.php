...
<script type="text/javascript">
    var type='id',stext,order='desc',ids='',imgcon=1,more,eurl="<?php echo Url::to(['coupon/examine-edit']);?>",
        listurl='<?php echo Url::to(['coupon/examine-list']); ?>',
        durl="";
</script>
