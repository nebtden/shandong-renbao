...
(function( $ ) {
    ...
    $.fn.extend({
		...
		*/
        musicUpload:function( opt, serverCallBack ) {
	...
	function getOption(objId) {
		...
		*/
		return {
			...
			pick:{
				id:objId,
				label:"<span class='am-icon-plus'></span> 选择音乐"
			},
			//类型限制;
			accept:{
				title:"Images",
				extensions:"mp3,txt,wav",
			...
			fileNumLimit:50,
			fileSizeLimit:15000 * 1024,
			fileSingleSizeLimit:32 * 1024 * 1024
		};
	}
