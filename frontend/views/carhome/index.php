...
<?php endif; ?>
    <p  class="yc-shuo-ul" style="color: #7e7e7e;padding-left: 20px">Copyright &copy; 2020 前海云车在线（深圳）信息技术有限公司 . <a href="http://beian.miit.gov.cn">粤ICP备18065077号</a>  </p>
...
<?php $this->beginBlock('script') ?>
    ...
    <script>
        //服务暂停提示
        //YDUI.dialog.alert('因春节期间，各地服务人员返乡，服务可能提供不了，敬请见谅，预计在 2020-02-09 08:00:00 恢复，感谢支持');
        //洗车服务 弹窗显示
        ...
        $('.exchange-wash-submit').on('touchstart', function () {
            ...
            $.post("<?php echo Url::to(['caruser/accoupon'])?>", {pwd: pwd}, function (json) {
