...
<div class="page-header am-fl am-cf">
    <h4>自营门店提现记录管理 <small>&nbsp;/&nbsp;列表页面</small></h4>
</div>
<div id="toolbar" class="btn-group">
    <form class="form-inline">
        ...
        <div class="form-group"><input type="text" id="withdrawals_no"   class="form-control" placeholder="提现单号"></div>
...
<script type="text/javascript">
    var type='id',stext,order='desc',ids='',imgcon=1,more,eurl="<?php echo Url::to(['selfshopcar/withdrawals_edit']);?>",
        listurl='<?php echo Url::to(['selfshopcar/withdrawals_log']); ?>',
    ...
    $("#download").click(function(){
        ...
        var opt4=$('#status').val();
        var opt5=$('#withdrawals_no').val();
        var url = '<?php echo Url::to(["selfshopcar/download_w"]);?>';
