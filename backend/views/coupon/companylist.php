...
<div id="toolbar" class="btn-group">
    <form class="form-inline">
        <button type="button" class="btn btn-default"  onclick="window.location.href='<?php echo Url::to(['coupon/companyedit']);?>';">
...
<table class="table table-bordered"  style="margin-top:10px;">
    ...
    <tr>
        ...
        <th  data-field="maxnum">券总数</th>
        <th  data-field="mealnum">套餐券数</th>
        <th  data-field="packagenum">券包数</th>
        <th  data-field="is_pnotice">包回调</th>
        <th  data-field="is_cnotice">券回调</th>
        <th  data-field="is_anotice">发包</th>
...
<script type="text/javascript">
    var type='id',stext,order='desc',ids='',imgcon=1,more,eurl="<?php echo Url::to(['coupon/companyedit']);?>",
        listurl='<?php echo Url::to(['coupon/companylist']); ?>',
