...
function queryParams(params) {
    var opt1 = $("#bank_code").val();
    var opt2 = $("#coupon_batch_no").val();
    var opt3 = $("#batch_no").val();
    var opt4 = $("#company_id").val();
    var opt5 = $("#status").val();
...
function actionFormatter(value, row, index) {
    return [
        '<a class="remove ml10" href="javascript:void(0)" title="Remove"><i class="glyphicon glyphicon-remove"></i>禁用</a>'
    ].join('');
