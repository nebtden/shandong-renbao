...
function queryParams(params) {
    var opt1 = $('#card_province').val();
    var opt2 = $('#card_char').val();
    var opt3 = $('#card_brand').val();
...
$('#sousuo').click(function () {
    ...
    var opt3 = $('#card_brand').val();
    var opt4 = $('#user_id').val();
    $('.table').bootstrapTable('refresh', {query: {card_province:opt1,card_char:opt2,card_brand:opt3,user_id:opt4}}, function (row) {
        console.log(row);
    });
});
