...
function queryParams(params) {
    ...
    var opt1=$('#shopname').val();
    var opt2=$('#shop_province').val();
    var opt3=$('#shop_city').val();
    var opt4=$('#shop_area').val();
...
$('#shopsousuo').click(function(){
    var opt1=$('#shopname').val();
    var opt2=$('#shop_province').val();
    var opt3=$('#shop_city').val();
    var opt4=$('#shop_area').val();

    $('.table').bootstrapTable('refresh',{query:{shopname:opt1,province:opt2,city:opt3,area:opt4}},function(row){
        console.log(row);
    });
});
...
function actionFormatter(value, row, index) {
    return [
        '<a class="edit ml10" href="javascript:void(0)" title="Edit" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-edit"></i>详情</a>&nbsp;&nbsp;',
