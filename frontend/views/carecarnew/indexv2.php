...
<script>
    ...
    sD.init(orderCommit, orderPolling, orderCostestimate, nearbyDriver, orderDriverPosition, orderPay, orderCancel);
...
<script>
    ...
    $('.card-list-ul>li>.content .btn').on('click', function (e) {
        ...
        var name = $(this).data('name'),
            ...
            id = $(this).data('id'),
            sn = $(this).data('sn');
        $(".commom-driving-ul>li.select-driving>.right>span").text(name);
        $(".commom-driving-ul>li.select-driving>.right>i").text(amount);
        sD.setCoupon(id, sn);
        $('.commom-input-place').hide();
    });
