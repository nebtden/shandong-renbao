...
<div id="toolbar" class="btn-group">
        <form class="form-inline">
            ...
            <button type="button" class="btn btn-default" id="remove">
             ...
             <button type="button" class="btn btn-default" onclick="writenewssubmits(this);">
                <i class="glyphicon glyphicon-trash" ></i>
            </button>
            <div class="form-group"><input type="text" id="uname" name="uname"  class="form-control" placeholder="标题名"></div>
            <div class="form-group"> <select id="sec" name="sec"  placeholder="用户ID"  class="form-control" >
