...
<!--        -->
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3" style="float: left;">
                <div>
                    <div id="hadpic" style="margin-top:10px"></div>
                    <input type="hidden" name="liaison_pic" id="liaison_pic" value=""/>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-3">
                 <textarea id="apply_desc" minlength="10" style="height:150px"  class="form-control"  placeholder="必要时可填写" name="apply_desc"></textarea>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <button type="button" class="btn btn-default" onclick="history.go(-1);">返回</button>
                <button type="button" class="btn btn-info" onclick="Leadin()">提交申请</button>
...
<script>
    ...
    function Leadin(){
        ...
        $.post('<?php echo Url::to(["coupon/apply-package"]); ?>',{
            generate_num:generate_num,
