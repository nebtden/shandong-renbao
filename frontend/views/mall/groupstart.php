...
<section class="MyOrderCont DetailsColor">
                ...
                <dd>
                    ...
                    <?php if($proinfo['id']==149 || $proinfo['id']==150){?>
                        ...
                        <div class="em webkitbox">
                            <i class="i1"></i>
                            <i class="i2" id='proNum' contenteditable="true">1</i>
                            <i class="i3"></i>
                        </div>
                    </div>
                </dd>
    ...
    <div class="kaituanBT" ><span onclick="tijiao();">确认开团</span></div>
</section>
...
<script>
     ...
     function tijiao(){
         ...
         if(tag==1){
         tag=2;
         $.post("<?php echo Url::toRoute('createorder');?>",{receiver:receiver,telphone:telphone,address:address,proid:proid,pronum:pronum,proprice:proprice,companyname:companyname},function(data){
