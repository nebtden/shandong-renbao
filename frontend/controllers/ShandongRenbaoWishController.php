...
//            return \GuzzleHttp\json_encode($return);
    ...
    public function getRewards($mobile){
       ...
       if($total1>=2000 and $total2>=1000 and $total3>=400 and $total4>=44 and $total5>=4){
           return 0;
       }
	   ...
	   if($rand>=0 and $rand<=$probalility){
		   ...
		   if($total1<2000 && $rand<500){
		        ...
		        return 2;
           }elseif($total3<400 && $rand>=850 and $rand<950){
               return 3;
           }elseif($total4<44 && $rand>=950 and $rand<990){
               return 4;
           }elseif($total5<4 && $rand>=990 ){
               return 5;
           }else{
		       if($total1<2000){
		           return 1;
