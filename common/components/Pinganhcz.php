...
//'merchart_shop' => '1240204265348141056',
//'client_id' => 'P_DINGHAN001',
//'client_secret' => 'eM8B1g3G'
    public function __construct()
    {
        $this->userName = '13142186218';
        $this->key = '243439B8C6583DA0';
        $this->url = 'https://test-api.pingan.com.cn:20443';
        $this->merchartShop = '1240204265348141056';
...
//        return $res;
     ...
     * @return bool|mixed|string
     */
    public function couponDetail($code,$merchartShop)
    {

        $url = '/open/vassPartner/appsvr/property/api/new/partner/v2/coupondetail';
        $url.='?redemptionCode='.$code.'&outletNo='.$merchartShop.'&thirdOutletNo='.$merchartShop.'&access_token='.$this->getToken().'&request_id='.time().'&userName='.$this->userName;

        $urlParam = [
            'redemptionCode' => $code,
            'outletNo' => $merchartShop,
            'thirdOutletNo'=>$merchartShop
        ];
