...
!function (window) {
    ...
    function CitySelect1 (element, options) {
        this.$element = $(element);
        this.options = $.extend({}, CitySelect1.DEFAULTS, options || {});
        this.init();
    }

    CitySelect1.DEFAULTS = {
        provance: '',
        city: '',
        area: ''
    };

    CitySelect1.prototype.init = function () {
        var _this = this,
    ...
    CitySelect1.prototype.open = function () {
        var _this = this;
        ...
        _this.$mask.on('click.ydui.cityselect1.mask', function () {
            _this.close();
        });
    ...
    CitySelect1.prototype.close = function () {
        var _this = this;
    ...
    CitySelect1.prototype.createDOM = function () {
        var _this = this;
    ...
    CitySelect1.prototype.setNavTxt = function (index, txt) {
    ...
    CitySelect1.prototype.bindItemEvent = function () {
        var _this = this,
    ...
    CitySelect1.prototype.returnValue = function () {
        var _this = this,
            defaultSet = _this.defaultSet;
    ...
    CitySelect1.prototype.scrollPosition = function (index) {
    ...
    CitySelect1.prototype.fillItems = function (index, arr) {
        var _this = this;
    ...
    CitySelect1.prototype.loadProvance = function () {
        var _this = this;
    ...
    CitySelect1.prototype.loadCity = function () {
        var _this = this;
    ...
    CitySelect1.prototype.loadArea = function () {
        var _this = this;
    ...
    function Plugin (option) {
        ...
        return this.each(function () {
            var $this = $(this),
                citySelect1 = $this.data('ydui.cityselect1');

            if (!citySelect1) {
                $this.data('ydui.cityselect1', (citySelect1 = new CitySelect1(this, option)));
            }

            if (typeof option == 'string') {
                citySelect1[option] && citySelect1[option].apply(citySelect1, args);
            }
        });
    }

    $.fn.citySelect1 = Plugin;
