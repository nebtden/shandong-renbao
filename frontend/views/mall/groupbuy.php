...
<script>
          setInterval(function(){
        	  ...
        	  var changetag=$('#changenum').attr('tag');
        	  var changehao=$('#changenum').attr('hao');
        	  $.post("<?php echo Url::toRoute('checkchange');?>",{orId:orId,changetag:changetag,changehao:changehao},function(data){
          	      if(data=='yes'){
           	    	 location.reload();
              	      }
             })              
